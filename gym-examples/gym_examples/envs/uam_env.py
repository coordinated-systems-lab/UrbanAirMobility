...
class UAM_Env(gym.Env):
    ...
    def __init__(self, airspace:aspc.Airspace, is_MDP:bool, pilot_function:Callable, rng:random.Random, current_time:float, max_time:float, time_step:float, nmac_distance:float):
    ...
    def uam_env(cls,
        ...
        airspace = aspc.Airspace.airspace(boundary=boundary,
        ...
        return cls(airspace, is_MDP, pilot_function, rng, 0, max_time, time_step, nmac_distance)
         
        


    def step(self, action) -> Tuple[ObsType, float, bool, bool, dict, bool,]:
