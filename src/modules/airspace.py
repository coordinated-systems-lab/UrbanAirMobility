...
from modules import abstractspawncontroller as abs_spwn_ctrl
from modules import constantspawnratecontroller as cnst_spwn_ctrlr
from modules import shapemanager as sm
from modules import pathfinder as pf
from modules import polar2 as p2
from modules import airspacestats as acs
from modules import aircraft as act
from modules import spawnfunction
...
class Airspace:
    ...
    def createEgoAircraft(self):
        ...
        start, destination = spawnfunction.ego_spawn_function(
            self.boundary,
            c2.Cartesian2(0, 0),
