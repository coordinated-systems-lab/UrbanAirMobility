...
class Aircraft:
    ...
    #factory function
    @classmethod
    def aircraft(cls,dynamic:dcs.Dynamics, destinations:List[c2.Cartesian2], max_acceleration:p2.Polar2, max_velocity:float, arrival_radius:float):
        stats = acs.AircraftStats.aircraftstats((abs(dynamic.position - destinations[-1])) - arrival_radius)
